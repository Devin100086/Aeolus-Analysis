...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(description="Train/evaluate CNN-LSTM for flight delay.")
    ...
    parser.add_argument("--checkpoint-path", default="cnnlstm_model_checkpoint.pth")
    parser.add_argument("--best-model-path", default="cnnlstm_best_model.pth")
...
def main() -> None:
    ...
    if config.plot:
        ...
        output_dir.mkdir(parents=True, exist_ok=True)
        plot_lr_schedule(lr_history, output_dir / "cosine_lr_schedule")
        plot_loss_curve(loss_history, output_dir / "training_loss")
